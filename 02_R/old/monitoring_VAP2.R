...
p <- ggplot(prop_period, aes(x = Messperiode, y = percent_correct, group = 1,
...
p2 <- ggplot(prop_period_by, aes(x = Messperiode, y = percent_correct, group = 1)) +
  geom_area(data = prop_period, aes(x = Messperiode, y = percent_correct), fill = "lightgray") +
  geom_errorbar(aes(ymin = CI_lo, ymax = CI_up), width = 0.1, col = "darkgray") +
  geom_point() +
  geom_line() +
  theme_bw() +
...
p2 <- ggplot(prop_period_by, aes(x = Messperiode, y = percent_correct, group = 1)) +
  geom_area(data = prop_period, aes(x = Messperiode, y = percent_correct,
